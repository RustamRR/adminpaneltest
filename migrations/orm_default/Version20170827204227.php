 ...
 */
class Version20170827204227 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE users_hierarchicalrole ADD CONSTRAINT FK_47D858867B3B43D FOREIGN KEY (users_id) REFERENCES users (user_id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
